...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	//--------------,--------,--------,--------,--------,--------,                    ,--------,--------,--------,--------,--------,--------,
               SH_OS,    PT_Q,    PT_W,    PT_E,    PT_R,    PT_T,                         PT_Y,    PT_U,    PT_I,    PT_O, PT_CCED, PT_ACUT,
	//--------------|--------|--------|--------|--------|--------|                    |--------|--------|--------|--------|--------|--------|
	...
	//-------|--------|--------|--------|--------|--------,                    |--------|--------|--------|--------|--------|--------|
	_______,_C(PT_DOT),_S(PT_4),_G(PT_5),_A(PT_6),    PT_0,                         PT_B,   KC_P4,   KC_P5,   KC_P6,    PT_E, PT_ASTR,
	//-------|--------|--------|--------|--------|--------,                    |--------|--------|--------|--------|--------|--------|
	...
	//-------,--------,--------,--------,--------,--------,                    ,--------,--------,--------,--------,--------,--------,
	  _______, PT_ACUT, PT_LABK, PT_SLSH, PT_RABK, PT_COLN,                      PT_AMPR, PT_LBRC, PT_QUES, PT_RBRC, PT_PERC, XXXXXXX,
	//-------|--------|--------|--------|--------|--------|                    |--------|--------|--------|--------|--------|--------|
	  _______,  M_PDIR, PT_BSLS, PT_MINS,  PT_EQL, PT_SCLN,                      PT_PIPE, PT_LPRN, PT_EXLM, PT_RPRN, PT_HASH, XXXXXXX,
	//-------|--------|--------|--------|--------|--------|                    |--------|--------|--------|--------|--------|--------|
	  _______,  PT_DLR,  PT_GRV, PT_PLUS, PT_ASTR, PT_CIRC,                      PT_TILD, PT_LCBR, PT_UNDS, PT_RCBR,   PT_AT, XXXXXXX,
	//-------|--------'--------|--------'--------|--------'--------,  ,--------'--------|--------'--------|--------'--------|--------'
	                    _______,          _______,          _______,             _______,          _______,          _______
	        //-----------------'-----------------'-----------------'  '-----------------'-----------------'-----------------'
	),
	...
	//-------,--------,--------,--------,--------,--------,                    ,--------,--------,--------,--------,--------,--------,
	  _______,  KC_F12,   KC_F7,   KC_F8,   KC_F9,  KC_F12,                     _______, _______, _______, _______, _______, XXXXXXX,
	//-------|--------|--------|--------|--------|--------,                    |--------|--------|--------|--------|--------|--------|
	  _______,  KC_F11,   KC_F4,   KC_F5,   KC_F6,  KC_F11,                      _______, _______, _______, _______, _______, XXXXXXX,
	//-------|--------|--------|--------|--------|--------,                    |--------|--------|--------|--------|--------|--------|
	  _______,  KC_F10,   KC_F1,   KC_F2,   KC_F3,  KC_F10,                      _______, _______, _______, _______, _______, XXXXXXX,
	//-------|--------'--------|--------'--------|--------'--------,  ,--------'--------|--------'--------|--------'--------|--------'
	...
	//-------,--------,--------,--------,--------,--------,                    ,--------,--------,--------,--------,--------,--------,
	   KC_TAB,    PT_Q,    PT_W,    PT_E,    PT_R,    PT_T,                         PT_Y,    PT_U,    PT_I,    PT_O,    PT_P,  KC_ESC,
	//-------|--------|--------|--------|--------|--------|                    |--------|--------|--------|--------|--------|--------|
	  KC_LSFT,    PT_A,    PT_S,    PT_D,    PT_F,    PT_G,                         PT_H,    PT_J,    PT_K,    PT_L, PT_CCED, PT_TILD,
	//-------|--------|--------|--------|--------|--------|                    |--------|--------|--------|--------|--------|--------|
	  KC_LCTL,    PT_Z,    PT_X,    PT_C,    PT_V,    PT_B,                         PT_N,    PT_M, PT_COMM,  PT_DOT, PT_MINS, PT_PLUS,
	//-------|--------'--------|--------'--------|--------'--------,  ,--------'--------|--------'--------|--------'--------|--------'
	                    KC_LALT,           KC_SPC,       OSL(L_NUM),             _______,          _______,          _______
	        //-----------------'-----------------'-----------------'  '-----------------'-----------------'-----------------'
	),
