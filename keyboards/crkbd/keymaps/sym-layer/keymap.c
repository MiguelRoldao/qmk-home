...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	//-------,--------,--------,--------,--------,--------,                    ,--------,--------,--------,--------,--------,--------,
	  _______,  KC_F12,   KC_F7,   KC_F8,   KC_F9,  KC_F15,                     _______, _______, _______, _______, _______, XXXXXXX,
	//-------|--------|--------|--------|--------|--------,                    |--------|--------|--------|--------|--------|--------|
	  _______,  KC_F11,   KC_F4,   KC_F5,   KC_F6,  KC_F14,                      _______, _______, _______, _______, _______, XXXXXXX,
	//-------|--------|--------|--------|--------|--------,                    |--------|--------|--------|--------|--------|--------|
