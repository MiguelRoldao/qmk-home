...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	//--------|--------|--------|--------|--------|                    |--------|--------|--------|--------|--------|
	   _______, _______, _______, _______, KC_BRIU,                      KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, KC_MPLY,
	//--------|--------|--------|--------|--------|                    |--------|--------|--------|--------|--------|
	   _______, _______, _______, _______, KC_BRID,                      KC_PSCR, KC_MUTE, KC_VOLD, KC_VOLU, KC_MNXT,
	//--------'--------|--------'--------|--------'--------,  ,--------'--------|--------'--------|--------'--------'
	...
	//-------,--------,--------,--------,--------,                    ,--------,--------,--------,--------,--------,
	  XXXXXXX, PT_LABK, PT_SLSH, PT_RABK, PT_COLN,                      PT_AMPR, PT_LBRC, PT_QUES, PT_RBRC, PT_PERC,
	//-------|--------|--------|--------|--------|                    |--------|--------|--------|--------|--------|
