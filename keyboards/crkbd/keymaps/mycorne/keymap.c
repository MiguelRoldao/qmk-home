...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	//-------,--------,--------,--------,--------,--------,                    ,--------,--------,--------,--------,--------,--------,
	TO(L_GAME),   PT_Q,    PT_W,    PT_E,    PT_R,    PT_T,                         PT_Y,    PT_U,    PT_I,    PT_O, PT_QUOT, PT_TILD,
	//-------|--------|--------|--------|--------|--------,                    |--------|--------|--------|--------|--------|--------|
	   MG_SFT,_C(PT_A),_S(PT_S),_G(PT_D),_A(PT_F),    PT_G,                         PT_H,_A(PT_J),_G(PT_K),_S(PT_L),_C(PT_P), PT_CCED,
	//-------|--------|--------|--------|--------|--------,                    |--------|--------|--------|--------|--------|--------|
	 TO(L_ALT),   PT_Z,    PT_X,    PT_C,    PT_V,    PT_B,                         PT_N,    PT_M, PT_COMM,  PT_DOT, PT_DQUO, PT_ACUT,
	//-------|--------'--------|--------'--------|--------'--------,  ,--------'--------|--------'--------|--------'--------|--------'
	           LT(L_CMD,KC_ESC), LT(L_NUM,KC_SPC), LT(L_FUN,KC_TAB),    LT(L_NAV,KC_ENT),LT(L_NUM,KC_BSPC),   ALGR_T(KC_DEL)
	        //-----------------'-----------------'-----------------'  '-----------------'-----------------'-----------------'
	),
	...
	//-------,--------,--------,--------,--------,--------,                    ,--------,--------,--------,--------,--------,--------,
	  XXXXXXX,    PT_C,    PT_7,    PT_8,    PT_9,    PT_F,                         PT_C,    PT_7,    PT_8,    PT_9,    PT_F, XXXXXXX,
	//-------|--------|--------|--------|--------|--------,                    |--------|--------|--------|--------|--------|--------|
	  XXXXXXX,_C(PT_B),_S(PT_4),_G(PT_5),_A(PT_6),    PT_E,                         PT_B,_A(PT_4),_G(PT_5),_S(PT_6),_C(PT_E), XXXXXXX,
	//-------|--------|--------|--------|--------|--------,                    |--------|--------|--------|--------|--------|--------|
	  XXXXXXX,    PT_A,    PT_1,    PT_2,    PT_3,    PT_D,                         PT_A,    PT_1,    PT_2,    PT_3,    PT_D, XXXXXXX,
	//-------|--------'--------|--------,--------|--------'--------,  ,--------'--------|--------'--------|--------'--------|--------'
	                       M_0B,             PT_0,             M_0X,                M_0X,             PT_0,             M_0B
	        //-----------------'-----------------'-----------------'  '-----------------'-----------------'-----------------'
	),
	...
	//-------|--------|--------|--------|--------|--------|                    |--------|--------|--------|--------|--------|--------|
	TO(L_BASE),   PT_X,    PT_C,    PT_M,    PT_P,    PT_V,                         PT_Z, PT_QUOT, PT_COMM,  PT_DOT, PT_DQUO, _______,
	//-------|--------'--------|--------'--------|--------'--------,  ,--------'--------|--------'--------|--------'--------|--------'
	                    _______,          _______,          _______,             _______,          _______,          _______
	        //-----------------'-----------------'-----------------'  '-----------------'-----------------'-----------------'
	),
	...
	[L_ALT] = LAYOUT_split_3x6_3(
	//-------,--------,--------,--------,--------,--------,                    ,--------,--------,--------,--------,--------,--------,
	TO(L_GAME),   PT_Q,    PT_W,    PT_D,    PT_R,    PT_F,                         PT_Y,    PT_U,    PT_K,    PT_L, PT_QUOT, PT_TILD,
	//-------|--------|--------|--------|--------|--------,        ASET        |--------|--------|--------|--------|--------|--------|
	   MG_SFT,_C(PT_A),_S(PT_S),_G(PT_E),_A(PT_T),    PT_G,                         PT_H,_A(PT_N),_G(PT_I),_S(PT_O),_C(PT_P), PT_CCED,
	//-------|--------|--------|--------|--------|--------,                    |--------|--------|--------|--------|--------|--------|
	TO(L_BASE),   PT_Z,    PT_X,    PT_C,    PT_V,    PT_B,                         PT_J,    PT_M, PT_COMM,  PT_DOT, PT_DQUO, PT_ACUT,
	//-------|--------'--------|--------'--------|--------'--------,  ,--------'--------|--------'--------|--------'--------|--------'
	           LT(L_CMD,KC_ESC), LT(L_NUM,KC_SPC), LT(L_FUN,KC_TAB),    LT(L_NAV,KC_ENT),LT(L_NUM,KC_BSPC),   ALGR_T(KC_DEL)
	        //-----------------'-----------------'-----------------'  '-----------------'-----------------'-----------------'
	),
	...
	//-------|--------|--------|--------|--------|--------,     COLEMAK-VH     |--------|--------|--------|--------|--------|--------|
	  _______,_C(PT_A),_S(PT_R),_G(PT_S),_A(PT_T),    PT_G,                         PT_M,_A(PT_N),_G(PT_E),_S(PT_I),_C(PT_P), _______,
	//-------|--------|--------|--------|--------|--------,                    |--------|--------|--------|--------|--------|--------|
	TO(L_BASE),   PT_Z,    PT_X,    PT_C,    PT_V,    PT_B,                      PT_DQUO,    PT_H, PT_COMM,  PT_DOT, PT_QUOT, _______,
	//-------|--------'--------|--------'--------|--------'--------,  ,--------'--------|--------'--------|--------'--------|--------'
	                    _______,          _______,          _______,             _______,          _______,          _______
	        //-----------------'-----------------'-----------------'  '-----------------'-----------------'-----------------'
	),
