...
#define MY_ENT LT(L_NAV, M_OSSFT)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	//--------|--------|--------|--------|--------|  |--------|--------|--------|--------|--------|
	   C(PT_Z), C(PT_X), C(PT_C), C(PT_V), C(PT_Y),    MS_BTN6, MS_BTN4, MS_BTN3, MS_BTN5, MS_ACL2,
	//--------'--------'--------|--------|--------|  |--------|--------|--------'--------'--------'
